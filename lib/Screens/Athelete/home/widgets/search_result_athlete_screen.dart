                              ...
                              return InkWell(
                                onTap: () {
                                  Get.to(() => CoachDetailsScreen(
                                        CoachData: controller.searchList[index],
                                      ));
                                },
                                child: Container(
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                Text(
                                                  "${controller.searchList[index]['name'].toString().capitalizeFirst}",
                                                  style:
                                                ...
                                                richText('Years of Coaching:',
                                                    " ${controller.searchList[index]['years_of_coaching']}"),
                                                richText('Sports:',
                                                    " ${fetchSport(controller.searchList[index]['sport_types'])}"),
